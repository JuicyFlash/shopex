...
def load_products
  @products.each do |product|
    ...
    product[:pictures].each do |picture|
      @product.pictures.attach(
        io: File.open(File.join(Rails.root, 'db/seeds/watches_images/', picture)),
        filename: picture
      )
    end
  end
